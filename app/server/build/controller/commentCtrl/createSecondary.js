...
const replyToPrimary = (0, utils_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const primaryComment = yield Primary_1.default.findById(req.params.primaryId).lean();
    if (!primaryComment) {
...
exports.default = [(0, validateSchemaMdlwr_1.default)(exports.schema), replyToPrimary];
