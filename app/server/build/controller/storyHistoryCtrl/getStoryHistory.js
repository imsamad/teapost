...
exports.getStoryHistory = void 0;
const utils_1 = require("../../lib/utils");
const Story_1 = __importDefault(require("../../models/Story"));
const StoryHistory_1 = __importStar(require("../../models/StoryHistory"));
exports.getStoryHistory = (0, utils_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!storyHistory)
        return next((0, utils_1.ErrorResponse)(400, 'No history found.'));
    res.send({
        status: 'ok',
        storyHistory: (0, StoryHistory_1.ParseDoc)(storyHistory),
    });
}));
exports.default = exports.getStoryHistory;
