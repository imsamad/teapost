...
const sendEmail = (to, redirectUrl, messsage) => __awaiter(void 0, void 0, void 0, function* () {
    const emailMessage = {
        to,
        from: {
            name: brandName,
    ...
    try {
        ...
        const res = yield mail_1.default.send(emailMessage);
        return true;
    }
    catch (err) {
...
function html(redirectUrl, brandName, message) {
