...
const sendVerifyEmail = (to, redirectUrl) => __awaiter(void 0, void 0, void 0, function* () {
    const message = {
        to,
        from: {
            name: brandName,
    ...
    return yield (0, sendEmail_1.default)(message);
});
exports.default = sendVerifyEmail;
function html(redirectUrl, brandName) {
